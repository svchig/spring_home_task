...
public class TestEvent {
	...
	public void testCheckAirDates() {
		...
		assertTrue(event.airsOnDates(LocalDateTime.now(), LocalDateTime.now().plusDays(10)));
		assertTrue(event.airsOnDates(LocalDateTime.now().minusDays(10), LocalDateTime.now().plusDays(10)));
		assertTrue(event.airsOnDates(LocalDateTime.now().plusDays(1), LocalDateTime.now().plusDays(1)));
		assertFalse(event.airsOnDates(LocalDateTime.now().minusDays(10), LocalDateTime.now().minusDays(5)));
