 ...
 * @author Yuriy_Tkach
 */
public interface BookingService extends AbstractDomainObjectService<Ticket>{
     ...
     * @return total price
     */
    public double getTicketsPrice(@Nonnull Event event, @Nonnull LocalDateTime date, @Nullable User user,
